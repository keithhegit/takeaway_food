...
const Modal = () => {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-80 backdrop-blur-sm">
            <div className={clsx(
                "bg-slate-800 border-2 rounded-xl p-6 max-w-md w-full shadow-[0_0_50px_rgba(0,0,0,0.5)] relative overflow-hidden animate-in fade-in zoom-in duration-200",
                typeColor
            )}>
                <h2 className="text-2xl font-bold mb-4 text-white text-shadow-md">{title}</h2>
