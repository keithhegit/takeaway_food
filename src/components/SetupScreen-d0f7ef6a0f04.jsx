...
const SetupScreen = () => {
    ...
    return (
        <div className="flex flex-col items-center justify-center h-full w-full bg-slate-900 absolute inset-0 z-50 p-8">
            <div className="max-w-5xl w-full bg-slate-800/90 backdrop-blur-xl border border-white/10 rounded-3xl p-10 shadow-2xl relative overflow-hidden">
                {/* Background Deco */}
                <div className="absolute top-0 left-0 w-full h-2 bg-gradient-to-r from-cyan-400 to-purple-500"></div>

                <h1 className="text-5xl font-bold text-center mb-10 text-white tracking-wider">
                    {step === 1 ? '胜利条件' : step === 2 ? '游戏设置' : '选择势力'}
                </h1>

                {step === 1 && (
                    <div className="text-center animate-in fade-in slide-in-from-bottom-5">
                        <label className="text-xl text-slate-300 mb-8 block">请选择获胜所需的店铺券数量</label>
                        <div className="flex justify-center gap-4 flex-wrap max-w-2xl mx-auto">
                            {[5, 6, 7, 8, 9, 10].map(num => (
                                <button
                                    ...
                                    className={clsx(
                                        "w-20 h-20 rounded-2xl text-3xl font-bold border-2 transition-all flex items-center justify-center group relative overflow-hidden",
                ...
                {step === 2 && (
                    <div className="text-center animate-in fade-in slide-in-from-bottom-5">
                        <label className="text-xl text-slate-300 mb-8 block">请选择能够参与外卖大战的玩家人数</label>
                        <div className="flex justify-center gap-8">
                            {[2, 3, 4].map(num => (
                                <button
                                    ...
                                    className={clsx(
                                        "w-24 h-24 rounded-2xl text-4xl font-bold border-2 transition-all flex items-center justify-center group relative overflow-hidden",
                    ...
                    <div className="animate-in fade-in slide-in-from-right-10">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 relative">
                            ...
                            {FACTIONS.map(faction => {
                                ...
                                const isSelected = false; // logic simplified
